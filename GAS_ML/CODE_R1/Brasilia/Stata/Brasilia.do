...
label variable Cartel_DF "Dummy variable for cartel period"


* TABLE 1: SUMMARY STATISTICS FOR THE NUMBER OF GAS STATIONS IN THE SAMPLE - BRASILIA
...
*-------------+---------------------------------------------------------
*N_GasStation |        489     62.6135    20.94176         22         80

* Hence, over the 489 weeks in the sample, we collect data from 411 different Gas Stations. On average, the weekly data is based on the price of 62.6135 gas stations**
...
keep Weekbegin Price_sd CV SPD Price_kurtosis Price_skewness N_GasStation Cartel_DF
order Weekbegin N_GasStation SPD Price_sd CV Price_skewness Price_kurtosis Cartel_DF


* Frequency of the cartel dummy variable - Cartel_DF
tabulate Cartel_DF

* TABLE 2: summary statistics for cartel and non-cartel periods - BRASILIA

bysort Cartel_DF: summarize SPD Price_sd CV Price_skewness Price_kurtosis


*GENERATE TABLE 3: STATISTICAL TESTS FOR THE SCREENS (MANN-WHITNEY AND KOLMOGOROV-SMIRNOV) - BRASILIA

* KOLMOGOROV-SMIRNOV
ksmirnov SPD , by (Cartel_DF)
ksmirnov Price_sd,  by (Cartel_DF)
ksmirnov CV , by (Cartel_DF)
ksmirnov Price_skewness , by (Cartel_DF)
ksmirnov Price_kurtosis , by (Cartel_DF)


*MANN-WHITNEY
ranksum SPD, by (Cartel_DF)
ranksum Price_sd,  by (Cartel_DF)
ranksum CV, by (Cartel_DF)
ranksum Price_skewness, by (Cartel_DF)
ranksum Price_kurtosis , by (Cartel_DF)
...
* Standard Scale transformation for the explanatory variables - Brasilia *
...
keep SPD_Norm CV_Norm Price_sd_Norm Price_skewness_Norm Price_kurtosis_Norm Cartel_DF
order SPD_Norm CV_Norm Price_sd_Norm Price_skewness_Norm Price_kurtosis_Norm Cartel_DF
...
export excel using "C:\Users\path...\Brasilia_ML_Std.xls", firstrow(variables)

** The excel file Brasilia_ML_Std.xls is used to evaluate the machine learning algorithms (in PYTHON) **
